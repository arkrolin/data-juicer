...
import sys
sys.path.append("/nas/daoyuan_lmm/codes/unified_vggt/process_data/dj_folder/dj_face_keypoints_new/data-juicer")
...
class VideoWholeBodyPoseEstimationMapperTest(DataJuicerTestCaseBase):
    ...
    def test(self):
        ...
        op = VideoWholeBodyPoseEstimationMapper(
            onnx_det_model="/nas/daoyuan_lmm/model/dwpose/yolox_l.onnx",
            onnx_pose_model="/nas/daoyuan_lmm/model/dwpose/dw-ll_ucoco_384.onnx",
            frame_num=1,
            duration=1,
            tag_field_name=MetaKeys.pose_estimation_tags,
            frame_dir="/nas/daoyuan_lmm/codes/unified_vggt/process_data/dj_folder/temp",
            if_save_visualization=True,
            save_visualization_dir="/nas/daoyuan_lmm/codes/unified_vggt/process_data/dj_folder/temp/vis"
        )
    ...
    def test_mul_proc(self):
        ...
        op = VideoWholeBodyPoseEstimationMapper(
            ...
            frame_dir="/nas/daoyuan_lmm/codes/unified_vggt/process_data/dj_folder/temp",
            if_save_visualization=True,
            save_visualization_dir="/nas/daoyuan_lmm/codes/unified_vggt/process_data/dj_folder/temp/vis2"
        )
        dataset = Dataset.from_list(self.ds_list)
        if Fields.meta not in dataset.features:
            dataset = dataset.add_column(name=Fields.meta,
    ...
    def test_from_extracted_frames(self):
        ...
        op = VideoWholeBodyPoseEstimationMapper(
            ...
            tag_field_name=MetaKeys.pose_estimation_tags,
            if_save_visualization=True,
            save_visualization_dir="/nas/daoyuan_lmm/codes/unified_vggt/process_data/dj_folder/temp/vis3"
        )
