...
class VggtMapperTest(DataJuicerTestCaseBase):
    ...
    def test(self):
        ...
        op = VggtMapper(
            ...
            frame_num=2,
            duration=2,
            frame_dir=os.path.join(DATA_JUICER_ASSETS_CACHE, "vggt_test1"),
    ...
    def test_mul_proc(self):
        ...
        op = VggtMapper(
            ...
            frame_num=2,
            duration=2,
            frame_dir=os.path.join(DATA_JUICER_ASSETS_CACHE, "vggt_test2"),
            if_output_camera_parameters=True,
            if_output_depth_maps=True,
            if_output_point_maps_from_projection=True,
            if_output_point_maps_from_unprojection=True,
    ...
    def test_point_maps_from_unprojection(self):
        ...
        op = VggtMapper(
            ...
            frame_num=2,
            duration=2,
            frame_dir=os.path.join(DATA_JUICER_ASSETS_CACHE, "vggt_test3"),
